...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  user1 = User.create(name: 'coal.msk@gmail.com', email: 'coal.msk@gmail.com', first_name: 'Anton', last_name: 'Mishin', type: 'Admin')
  user2 = User.create(name: 'new@gmail.com', email: 'new@gmail.com', first_name: 'User', last_name: 'User')
